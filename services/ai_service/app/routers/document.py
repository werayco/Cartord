...
from app.core.utils import get_admin, get_current_user, get_user
...
@router.get("/query/")
async def query_document(question: str,db: AsyncSession = Depends(get_db),current_user: dict = Depends(get_user),):
